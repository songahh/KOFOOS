...
class _FoodSelectionPageState extends State<FoodSelectionPage> {
  ...
  void submitSelection() async {
    ...
    var url = Uri.parse('http://192.168.64.241:8080/api/users/14/dislikes');
        ...
        child: Container(
          ...
          child: Center(
            ...
            child: Column(
              ...
              children: [
                Image.asset('assets/icon/${food.image}.png', width: imageSize, height: imageSize),
  ...
  Widget selectedFoodChip(Food food) {
    return Chip(
      ...
      backgroundColor: getFoodColor(food.name), // 음식별 지정된 색상을 사용
      label: Text(
        food.name,
...
List<Food> foodList = [
  ...
  Food(id:11, name: 'chicken&duck', image: 'chicken&duck'),
